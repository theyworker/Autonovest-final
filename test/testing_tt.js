var tt = artifacts.require("tt");
  ...
  contract('tt', function(accounts){
    it('Should buy a car', function(){

      return tt.deployed().then(function(inst){
              ...
              return inst.getAmountRaised.call(0).then(function(amtrs){
                ...
                return inst.getBalance.call().then(function(blnc){
                  ...
                  return inst.getForSale.call(0).then(function(fs){
                    ...
                    return inst.usersOwnership('0xb67845528ee09533a1888d58224345467bF45eCd').then(function(numinv){
                      console.log('Number of Investments'+numinv);
                    })
                  })
                })
              })
